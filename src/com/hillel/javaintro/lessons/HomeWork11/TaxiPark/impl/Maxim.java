package com.hillel.javaintro.lessons.HomeWork11.TaxiPark.impl;

import com.hillel.javaintro.lessons.HomeWork11.TaxiPark.TaxiPark;
...
public class Maxim implements TaxiPark {
    ...
    public VehicleImpl[] getVehiclesByMaxSpeed(int max, int min) {
